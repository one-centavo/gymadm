<div x-data="{ open: @entangle('open') }"
     @open-registration-form-with-document.window="open = true; $wire.document_number = $event.detail.documento"
     class="relative">
    ...
    <div x-show="open"
        ...
        <div class="flex justify-between items-center mb-8">
            <h2 class="text-3xl font-black uppercase tracking-tighter italic">NUEVO MIEMBRO</h2>
