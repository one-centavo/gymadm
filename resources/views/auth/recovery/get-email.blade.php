...
<p class="text-sm text-gray-500">Ingresa tu correo electrónico para recuperar tu cuenta</p>

<div class="space-y-8">
    <div class="space-y-2">
        <label class="text-sm font-black">CORREO ELECTRÓNICO</label>
        <input type="email" placeholder="tu@correo.com" wire:model="email" wire:key="input-email"
...
<div class="mt-4 flex items-center justify-center gap-2">
    ...
    <a href="{{ route('login') }}"
        class="text-sm text-black underline underline-offset-4 decoration-gym-blue decoration-3 cursor-pointer hover:bg-gray-400/20">Inicia
        sesión</a>
</div>
