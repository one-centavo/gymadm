...
use App\Livewire\Admin\History\Index as AdminHistory;
use App\Livewire\Member\History\Index as MemberHistory;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:admin')->prefix('admin')->group(function () {
        ...
        Route::get('/historial', AdminHistory::class)->name('admin.history');
